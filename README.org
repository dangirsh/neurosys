...
- [[#xmonad][XMonad]]
  ...
  - [[#keybindings][Keybindings]]
    - [[#default][Default]]
    - [[#custom][Custom]]
      - [[#rebooting--restarting][Rebooting / Restarting]]
      - [[#launcher--window-switcher][Launcher / Window Switcher]]
      - [[#running-emacs][Running Emacs]]
      - [[#lock-screen][Lock Screen]]
      - [[#horizontal-resizing][Horizontal Resizing]]
      - [[#window-minimization--restoration][Window Minimization / Restoration]]
      - [[#fullscreen][Fullscreen]]
      - [[#workspace-swapping][Workspace Swapping]]
      - [[#changing-number-of-master-windows][Changing number of master windows]]
      - [[#easier-kill-binding][Easier Kill Binding]]
      - [[#volume-control][Volume Control]]
      - [[#screenshots][Screenshots]]
      - [[#add-workspace-0][Add Workspace 0]]
      - [[#arandr][Arandr]]
...
I use XMonad as a window manager and minimal desktop environment. I don't run any additional desktop environment (e.g. XFCE). Insstead, I have the interface to the few things I need configred here in Haskell.

I've don't use any system trays / status bars / panels, since the Emacs modeline is already enough. This choice reduces the complexity of the XMonad configuration, and obviates depending on things like xmobar or polybar.
...
I don't run a desktop environment...
...
The ~main.sh~ is a symlink to an Arandr script that sets up my current monitor configuration.
...
Since that functionality seems to be default.

[[file:~/repos/xmonad/man/xmonad.hs::\[((m .|. modm, key), screenWorkspace sc >>= flip whenJust (windows . f))]]
