...
Together, these fully define a my computing environment, which strives to be

- *Effective*: interactions with code/data should occur at the speed of thought.
- *Long-lived*: should fight entropy until the end of the keyboard + screen era.
- *Minimal*: less is more for the base configuration, remembering that Nix enables
